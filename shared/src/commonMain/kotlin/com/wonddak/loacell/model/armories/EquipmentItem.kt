...
data class EquipmentItem(
    ...
    fun getItemLevel(): String {
        ...
        return makeJsonObject().jsonObject["Element_001"]!!.jsonObject["value"]!!.jsonObject["leftStr2"]!!.toString().replace("\"","")
    }
    ...
    fun getItemSetOptionLevels() : String {
        ...
        makeJsonObject().jsonObject["Element_008"]!!.let { part ->
            if (part.jsonObject["type"]!!.toString().replace("\"","") == "ItemPartBox") {
                return part.jsonObject["value"]!!.jsonObject["Element_001"]!!.toString().replace("\"","")
            }
        }
        //엘릭서 효과 있는 경우
    ...
    fun getElixirOptionLevels() : List<String>  {
        ...
        makeJsonObject().jsonObject["Element_007"]!!.let { part ->
            if (part.jsonObject["type"]!!.toString().replace("\"","") == "IndentStringGroup") {
                for (i in 0..1) {
                    resultList.add(part.jsonObject["value"]!!.jsonObject["Element_000"]!!.jsonObject["contentStr"]!!.jsonObject["Element_00$i"]!!.jsonObject["contentStr"]!!.toString().replace("\"",""))
                }
            }
        }
    ...
    fun getItemStatus() : List<String> {
        ...
        return makeJsonObject().jsonObject["Element_005"]!!.jsonObject["value"]!!.jsonObject["Element_001"]!!.toString().replace("\"","").split("<BR>")
    }
    ...
    fun getItemEngraves() : List<String> {
        ...
        val item = makeJsonObject().jsonObject["Element_006"]!!.jsonObject["value"]!!.jsonObject["Element_000"]!!.jsonObject["contentStr"]!!
        val resultList = mutableListOf<String>()
        for (i in 0..2) {
            resultList.add(item.jsonObject["Element_00$i"]!!.jsonObject["contentStr"]!!.toString().replace("\"","").replace("<BR>",""))
        }
        return resultList
    }
    ...
    fun getBraceletOptions() : List<String> {
        ...
        val optionString = makeJsonObject().jsonObject["Element_004"]!!.jsonObject["value"]!!.jsonObject["Element_001"]!!.toString().replace("\"","")
    ...
    fun getItemHealth() : List<String> {
        ...
        val resultList = mutableListOf<String>()
        for (i in 4..5) {
            val item = makeJsonObject().jsonObject["Element_00$i"]!!.jsonObject["value"]!!.jsonObject["Element_001"]!!
