...
enum class RaidType(val maxPerson: Int) {
    ...
    fun getMinLevel(difficulty: Difficulty, gateway: Int = 0): Int {
        return when (this) {
            ...
            EGIR -> when (difficulty) {
                Difficulty.Normal -> 1660
                Difficulty.Hard -> 1680
                else -> 0
            }
            ABRELSHUD2 -> when(difficulty) {
                Difficulty.Normal -> 1670
                Difficulty.Hard -> 1690
                else -> 0
            }
    ...
    fun getMaxGate(
        ...
        return when (this) {
            VALTAN, VYKAS, ECHIDNA, BETHEMOTH, EGIR, ABRELSHUD2-> 2
    ...
    fun getMaxParty(): Int {
        return when (this) {
            VALTAN, VYKAS, ABRELSHUD, ILLIAKAN, KAMEN, ECHIDNA, EGIR, ABRELSHUD2, ETC -> 2
